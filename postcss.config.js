module.exports = {
  plugins: {
    ...
    "postcss-px-to-viewport": {
      ...
      selectorBlackList: ['ignore','tab-bar','tab-bar-item','navbar','tabControl','backtop'],//指定不转换为视窗单位的类 
      minPixelValue: 1,// 小于或等于`1px`不转换为视窗单位
      mediaQuery: false,// 允许在媒体查询中转换`px`，默认false
      exclude:[/node_modules/], //如果是regexp, 忽略全部匹配文件;如果是数组array, 忽略指定文件
      exclude:[/TabControl/,/Tabbar/,/DetailBottomBar/,/CartBottom/], // 正则表达式，匹配的内容是不想被转换单位的文件名，添加了这种匹配后凡是文件名中带有这些字符的全部排除
    }
  }
}
